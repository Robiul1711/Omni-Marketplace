      ...
      <div className="bg-white p-4 shadow-xl border border-gray-100 rounded-2xl">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <p className="text-[13px] text-[#6F767E]">Total Revenues</p>
  ...
  return (
    <div className="bg-white p-6 rounded-[24px] border border-gray-100 shadow-sm h-full">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
        <div>
          <h2 className="text-[20px] font-bold text-[#1A1D1F]">Revenues and Order</h2>
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[13px] font-medium text-[#6F767E]">Revenues</span>
          </div>
          <div className="flex items-center gap-2">
