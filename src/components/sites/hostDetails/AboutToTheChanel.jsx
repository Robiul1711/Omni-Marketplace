  ...
  return (
    <section className="section-padding-x">
      <div className="w-full bg-white border border-gray-100 rounded-[24px] overflow-hidden shadow-sm">
        ...
        <div className="bg-[#EFF6FF] px-8 md:px-12 py-7">
          <h2 className="text-[22px] font-bold text-gray-900 font-inter!">About the Channel</h2>
        </div>

        {/* Content Section with Light Gray Background */}
        <div className="bg-gray-50/50 px-8 md:px-12 py-12 space-y-8">
